...
public class TuneUpMeActivityBandProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tune_up_me_band_profile);
        ...
        ActivityResultLauncher<PickVisualMediaRequest> pickMedia =
                registerForActivityResult(new ActivityResultContracts.PickVisualMedia(), uri -> {
                    if (uri != null) {
                        ...
                        ImageView imageView = findViewById(R.id.imageViewBandProfileImage);

                        if (imageView != null) {
                            imageView.setImageURI(uri);
                            selectImage = uri;
                            uploadImage(uri, "upload", "band", Objects.requireNonNull(getIntent().getStringExtra("id")));
                        } else {
        ...
        CardView cardViewBandProfileImageMain = findViewById(R.id.cardViewBandProfileImageMain);
        @SuppressLint("CutPasteId") ImageView imageViewBandProfileImage = findViewById(R.id.imageViewBandProfileImage);


        View.OnClickListener clickListener = v -> {
            animateCardClick(cardViewBandProfileImageMain);
            if (v.getId() == R.id.cardViewBandProfileImageMain) {
                requestPermissions();
                pickMedia.launch(new PickVisualMediaRequest.Builder()
                        .setMediaType(ActivityResultContracts.PickVisualMedia.ImageOnly.INSTANCE)
                        .build());
            } else if (v.getId() == R.id.imageViewBandProfileImage) {
                requestPermissions();
                pickMedia.launch(new PickVisualMediaRequest.Builder()
                        .setMediaType(ActivityResultContracts.PickVisualMedia.ImageOnly.INSTANCE)
                        .build());
        ...
        cardViewBandProfileImageMain.setOnClickListener(clickListener);
        imageViewBandProfileImage.setOnClickListener(clickListener);


        EditText nameEditTextBandProfile = findViewById(R.id.nameEditTextBandProfile);
        EditText emailEditTextBandProfile = findViewById(R.id.emailEditTextBandProfile);
        EditText mobileEditTextBandProfile = findViewById(R.id.mobileEditTextBandProfile);
        EditText pricePerHourEditTextBandProfile = findViewById(R.id.pricePerHourEditTextBandProfile);
        EditText descriptionEditTextBandProfile = findViewById(R.id.descriptionEditTextBandProfile);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (documentSnapshot.exists()) {
                                nameEditTextBandProfile.setText(documentSnapshot.getString("name"));
                                emailEditTextBandProfile.setText(documentSnapshot.getString("email"));
                                mobileEditTextBandProfile.setText(documentSnapshot.getString("mobile"));
                                pricePerHourEditTextBandProfile.setText(documentSnapshot.getString("price_per_hour"));
                                descriptionEditTextBandProfile.setText(documentSnapshot.getString("description"));
                                email = documentSnapshot.getString("email");
                                downloadImage("download", "band", getIntent().getStringExtra("id"), documentSnapshot.getString("profile_image_path"), new ImageDownloadCallback() {
                                    @Override
        ...
        TextView buttonSaveBandProfile = findViewById(R.id.buttonSaveBandProfile);
        buttonSaveBandProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                animateCardClick(v);

                String name = nameEditTextBandProfile.getText().toString();
                String pricePerHour = pricePerHourEditTextBandProfile.getText().toString();
                String description = descriptionEditTextBandProfile.getText().toString();

                if (name.isEmpty() || name.trim().isEmpty()) {
                    Toasty.error(TuneUpMeActivityBandProfile.this, "Please Enter Band Name !", Toast.LENGTH_LONG, true).show();
                } else if (pricePerHour.isEmpty() || pricePerHour.trim().isEmpty()) {
                    Toasty.error(TuneUpMeActivityBandProfile.this, "Please Enter Hour Rate !", Toast.LENGTH_LONG, true).show();
                } else if (!Validations.isDouble(pricePerHour) || !Validations.isInteger(pricePerHour)) {
                    Toasty.error(TuneUpMeActivityBandProfile.this, "Invalid Price !", Toast.LENGTH_LONG, true).show();
                } else if (description.isEmpty() || description.trim().isEmpty()) {
                    Toasty.error(TuneUpMeActivityBandProfile.this, "Please Enter Description !", Toast.LENGTH_LONG, true).show();
                } else {

                    HashMap<String, Object> hashMap = new HashMap<>();
                    hashMap.put("name", name);
                    hashMap.put("price_per_hour", pricePerHour);
                    ...
                    firebaseFirestore.collection("band")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    Toasty.success(TuneUpMeActivityBandProfile.this, "Profile Successfully Updated", Toast.LENGTH_LONG, true).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toasty.error(TuneUpMeActivityBandProfile.this, "Oops Something went wrong, profile not updated", Toast.LENGTH_LONG, true).show();
                                }
                            });
                    ...
                    try {
                        ...
                        if (status) {
                                ...
                                public void run() {
                                    ...
                                    firebaseFirestore.collection("band")
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void unused) {
                                                    SQLiteHelper sqLiteHelper = new SQLiteHelper(TuneUpMeActivityBandProfile.this, "TuneUpMe", null, 2);
                                                    new Thread(new Runnable() {
                                                        ...
                                                        public void run() {
                                                            ...
                                                            sqLiteDatabase.update("band", contentValues, whereClause, whereArgs);
                                                            removeImage("band",Objects.requireNonNull(getIntent().getStringExtra("id")));
                                                            downloadImage("download", "band", getIntent().getStringExtra("id"), savedPath, new ImageDownloadCallback() {
                                                                @Override
                                                                public void onSuccess(Uri imageUri) {
                                                                    runOnUiThread(() -> {
                                                                        ImageView imageView = findViewById(R.id.imageViewBandProfileImage);
                                                    ...
                                                    Toasty.success(TuneUpMeActivityBandProfile.this, message, Toast.LENGTH_LONG, true).show();
                                                }
                                            })
                                            .addOnFailureListener(new OnFailureListener() {
                                                @Override
                                                public void onFailure(@NonNull Exception e) {
                                                    Toasty.error(TuneUpMeActivityBandProfile.this, "Oops Something went wrong !", Toast.LENGTH_LONG, true).show();
                                                }
                                            });
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toasty.error(TuneUpMeActivityBandProfile.this, message, Toast.LENGTH_LONG, true).show();
                                }
                            });
